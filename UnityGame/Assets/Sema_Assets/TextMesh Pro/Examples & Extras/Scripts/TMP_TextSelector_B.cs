...
namespace TMPro.Examples1
{

    public class TMP_TextSelector_B1 : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
