...
namespace TMPro.Examples2
{

    public class TMP_TextSelector_B2 : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
